...

{
  ...
  echo '<tr>
		...
		<h4 align="center" style="margin:0px;font-size:17px;"><b>PEMINATAN : IPA (Ilmu Pengetahuan Alam)</b></h4>
  ...
  echo '<tr>
    <table width="80%" border="0" align="center">
	<td align="justify" width="7%">Yang bersangkutan dinyatakan <b>LULUS</b> berdasarkan hasil Keputusan Rapat Pleno Kelulusan Dewan Guru SMA Negeri 9 Luwu Utara pada hari Senin tanggal 3 Mei 2021, dengan nilai sebagai berikut:</td><br><br>
    </tr>';
  echo '<tr>
	<table width="200%" border="0">
    <td width="50">&nbsp;</td>
...
echo '<tr>
	...
	echo '<tr>
		<td align="center">5</td>
		<td align="left">Ekonomi (Lintas Minat)</td>
		<td align="center">'.$r['ekolm'].' </td>
	</tr>';
